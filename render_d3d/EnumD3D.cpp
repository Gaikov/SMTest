...
nsUtilsD3D::nsUtilsD3D( IDirect3D8 *d3d, UINT devID, D3DDEVTYPE devType )
{
	m_d3d = d3d;
	SetCurrentDevice( devID, devType );
}
...
//-----------------------------------------------------
const char* nsUtilsD3D::GetErrorDesc( HRESULT hr )
{
...
//-----------------------------------------------------
const formatDesc_t* nsUtilsD3D::GetFormatDesc( D3DFORMAT fmt )
{
